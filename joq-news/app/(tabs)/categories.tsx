...
const CAT_DESC: Record<string, string> = {
  ...
  'kape': 'Njoftime, Prona, Automjete, Pazari',
            ...
            >
              ...
              <View style={st.liveRow}>
                <View style={{ flex: 1 }}>
                  ...
                  <Svg width={130} height={39} viewBox="0 0 200 60" style={{ marginTop: 2 }}>
          ...
          >
            ...
            <View style={st.kapeRow}>
              <View style={{ flex: 1 }}>
                ...
                <Text style={st.kapeSub}>Njoftime, Prona, Automjete, Pazari dhe me shume</Text>
              </View>
